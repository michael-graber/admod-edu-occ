...
preserve 
	...
	gsort -percent
	save ${data}/mode_edu_3_within_occ_4.dta, replace
restore

// modal education within occupation, alternative education grouping
preserve
	...
	order occ_4 occ_4_label licensed edu_3 edu_3_label freq percent
	gsort -percent
	save ${data}/mode_edu_3alt_within_occ_4.dta, replace
restore
...
preserve 
	...
	gsort -percent
	save ${data}/mode_edu_3_within_occ_4_nace_1.dta, replace
restore
...
preserve 
	...
	gsort -percent
	save ${data}/mode_occ_4_within_edu_3.dta, replace
restore

// modal occupation within education, alternative education grouping
preserve 
	replace edu_3 = "7" + substr(edu_3, 2, 3) if (substr(edu_3, 1, 1) == "6" | substr(edu_3, 1, 1) == "8") 
	replace edu_3 = "4" + substr(edu_3, 2, 3) if (substr(edu_3, 1, 1) == "3" | substr(edu_3, 1, 1) == "5")
	contract edu_3 occ_4, freq(freq) 
	...
	order edu_3 edu_3_label occ_4 occ_4_label licensed freq percent
	gsort -percent
	save ${data}/mode_occ_4_within_edu_3alt.dta, replace
restore
...
preserve 
	...
	gsort -percent
	save ${data}/mode_occ_4_within_edu_3_nace_1.dta, replace
restore
